...
const logFilePath = path_1.default.join(process.cwd(), "app.log");
...
class ConsoleLogger {
    ...
    log(level, record) {
        ...
        fs_1.default.appendFileSync(logFilePath, out);
        switch (level) {
            case "info":
                console.info(out);
                break;
...
class PinoLogger {
    constructor() {
        this.logger = (0, pino_1.default)({}, pino_1.default.destination({
            dest: "app.log",
            sync: false,
        }));
    }
